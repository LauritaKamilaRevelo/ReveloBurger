...
namespace ReveloBurger.Controllers
{
    public class PromosController : Controller
    {
        private readonly ReveloBurgerContext _context;

        public PromosController(ReveloBurgerContext context)
        {
            _context = context;
        }
        ...
        {
            var reveloBurgerContext = _context.Promo.Include(p => p.Burger);
            return View(await reveloBurgerContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("PromoId,Descipcion,FechaPromo,BurgerId")] Promo promo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PromoId,Descipcion,FechaPromo,BurgerId")] Promo promo)
        {
            if (id != promo.PromoId)
            {
                return NotFound();
